...
namespace Celestial.Animations
{
    ...
    public sealed class Astronaut : IAnimatedVisualSource
    {
        ...
        sealed class AnimatedVisual : IAnimatedVisual
        {
            ...
            CompositionColorBrush _animatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_0;
            CompositionColorBrush _colorBrush_AlmostChocolate_FFEA6C17;
            CompositionColorBrush _colorBrush_AlmostDarkSlateBlue_FF465F7A;
            CompositionColorBrush _colorBrush_AlmostDarkSlateGray_FF334F6C;
            CompositionColorBrush _colorBrush_AlmostDimGray_FF707174;
            CompositionColorBrush _colorBrush_AlmostLightGray_FFC6D3E2;
            CompositionColorBrush _colorBrush_AlmostMidnightBlue_FF001B46;
            CompositionColorBrush _colorBrush_AlmostMidnightBlue_FF002D5B;
            CompositionColorBrush _colorBrush_AlmostSandyBrown_FFEF9450;
            CompositionColorBrush _colorBrush_AlmostSilver_FFB5BBC4;
            CompositionColorBrush _colorBrush_AlmostSilver_FFC2C8D1;
            ...
            // Path 1
            CompositionColorBrush AnimatedColorBrush_AlmostDarkGray_FF8EA7C1_to_TransparentAlmostDarkGray_008EA7C1_0()
            {
                var result = _c.CreateColorBrush(Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1));
                result.StartAnimation("Color", ColorAnimation_AlmostDarkGray_FF8EA7C1_to_TransparentAlmostDarkGray_008EA7C1_0());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
                _reusableExpressionAnimation.ClearAllParameters();
                _reusableExpressionAnimation.Expression = "_.Progress * 0.955414";
            ...
            // Path 1
            CompositionColorBrush AnimatedColorBrush_AlmostDarkGray_FF8EA7C1_to_TransparentAlmostDarkGray_008EA7C1_1()
            {
                var result = _c.CreateColorBrush(Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1));
                result.StartAnimation("Color", ColorAnimation_AlmostDarkGray_FF8EA7C1_to_TransparentAlmostDarkGray_008EA7C1_1());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
            ...
            // Path 1
            CompositionColorBrush AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_SemiTransparentAlmostSilver_33B5BBC4()
            {
                var result = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4));
                result.StartAnimation("Color", ColorAnimation_AlmostSilver_FFB5BBC4_to_SemiTransparentAlmostSilver_33B5BBC4());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
                _reusableExpressionAnimation.ClearAllParameters();
                _reusableExpressionAnimation.Expression = "_.Progress * 0.9202454";
                _reusableExpressionAnimation.SetReferenceParameter("_", _root);
                controller.StartAnimation("Progress", _reusableExpressionAnimation);
                return result;
            }
            ...
            // Path 1
            CompositionColorBrush AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_SemiTransparentAlmostSilver_4CB5BBC4()
            {
                var result = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4));
                result.StartAnimation("Color", ColorAnimation_AlmostSilver_FFB5BBC4_to_SemiTransparentAlmostSilver_4CB5BBC4());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
            ...
            CompositionColorBrush AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_0()
            {
                var result = _animatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_0 = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4));
                result.StartAnimation("Color", ColorAnimation_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_0());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
                controller.StartAnimation("Progress", _scalarExpressionAnimation);
                return result;
            ...
            // Path 1
            CompositionColorBrush AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_1()
            {
                var result = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4));
                result.StartAnimation("Color", ColorAnimation_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_1());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
                controller.StartAnimation("Progress", _scalarExpressionAnimation);
                return result;
            ...
            // Path 1
            CompositionColorBrush AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_2()
            {
                var result = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4));
                result.StartAnimation("Color", ColorAnimation_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_2());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
                _reusableExpressionAnimation.ClearAllParameters();
                _reusableExpressionAnimation.Expression = "_.Progress * 0.9433963";
                _reusableExpressionAnimation.SetReferenceParameter("_", _root);
                controller.StartAnimation("Progress", _reusableExpressionAnimation);
                return result;
            }

            // Layer (Shape): Layer 2 Outlines
            // Path 1
            CompositionColorBrush AnimatedColorBrush_SemiTransparentAlmostCoral_4CEE9545_to_TransparentAlmostCoral_00EE9545()
            {
                var result = _c.CreateColorBrush(Color.FromArgb(0x4C, 0xEE, 0x95, 0x45));
                result.StartAnimation("Color", ColorAnimation_SemiTransparentAlmostCoral_4CEE9545_to_TransparentAlmostCoral_00EE9545());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
                controller.StartAnimation("Progress", _scalarExpressionAnimation);
                return result;
            ...
            // Path 1
            CompositionColorBrush AnimatedColorBrush_SemiTransparentAlmostLightSalmon_4CFFC270_to_TransparentAlmostLightSalmon_00FFC270()
            {
                var result = _c.CreateColorBrush(Color.FromArgb(0x4C, 0xFF, 0xC2, 0x70));
                result.StartAnimation("Color", ColorAnimation_SemiTransparentAlmostLightSalmon_4CFFC270_to_TransparentAlmostLightSalmon_00FFC270());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
                controller.StartAnimation("Progress", _scalarExpressionAnimation);
                return result;
            ...
            // Path 1
            CompositionColorBrush AnimatedColorBrush_TransparentAlmostSilver_00B5BBC4_to_TransparentAlmostSilver_00B5BBC4()
            {
                var result = _c.CreateColorBrush(Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4));
                result.StartAnimation("Color", ColorAnimation_TransparentAlmostSilver_00B5BBC4_to_TransparentAlmostSilver_00B5BBC4());
                var controller = result.TryGetAnimationController("Color");
                controller.Pause();
                controller.StartAnimation("Progress", _scalarExpressionAnimation);
                return result;
            ...
            // Color
            ColorKeyFrameAnimation ColorAnimation_AlmostDarkGray_FF8EA7C1_to_TransparentAlmostDarkGray_008EA7C1_0()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                // AlmostDarkGray_FF8EA7C1
                result.InsertKeyFrame(0, Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1), _holdThenStepEasingFunction);
                // TransparentAlmostDarkGray_008EA7C1
                result.InsertKeyFrame(0.0445859842F, Color.FromArgb(0x00, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // AlmostDarkGray_FF8EA7C1
                result.InsertKeyFrame(0.108280249F, Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // TransparentAlmostDarkGray_008EA7C1
                result.InsertKeyFrame(0.178343937F, Color.FromArgb(0x00, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // AlmostDarkGray_FF8EA7C1
                result.InsertKeyFrame(0.299363047F, Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // TransparentAlmostDarkGray_008EA7C1
                result.InsertKeyFrame(0.426751584F, Color.FromArgb(0x00, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // AlmostDarkGray_FF8EA7C1
                result.InsertKeyFrame(0.554140091F, Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // TransparentAlmostDarkGray_008EA7C1
                result.InsertKeyFrame(0.745222926F, Color.FromArgb(0x00, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // AlmostDarkGray_FF8EA7C1
                result.InsertKeyFrame(0.878980875F, Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // TransparentAlmostDarkGray_008EA7C1
                result.InsertKeyFrame(1, Color.FromArgb(0x00, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                return result;
            }

            // Color
            ColorKeyFrameAnimation ColorAnimation_AlmostDarkGray_FF8EA7C1_to_TransparentAlmostDarkGray_008EA7C1_1()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                ...
                result.InsertKeyFrame(0, Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1), _holdThenStepEasingFunction);
                // TransparentAlmostDarkGray_008EA7C1
                result.InsertKeyFrame(0.0733333305F, Color.FromArgb(0x00, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // AlmostDarkGray_FF8EA7C1
                result.InsertKeyFrame(0.199999988F, Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // TransparentAlmostDarkGray_008EA7C1
                result.InsertKeyFrame(0.333333313F, Color.FromArgb(0x00, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // AlmostDarkGray_FF8EA7C1
                result.InsertKeyFrame(0.466666639F, Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // TransparentAlmostDarkGray_008EA7C1
                result.InsertKeyFrame(0.666666627F, Color.FromArgb(0x00, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // AlmostDarkGray_FF8EA7C1
                result.InsertKeyFrame(0.806666613F, Color.FromArgb(0xFF, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                // TransparentAlmostDarkGray_008EA7C1
                result.InsertKeyFrame(0.933333337F, Color.FromArgb(0x00, 0x8E, 0xA7, 0xC1), _cubicBezierEasingFunction_0);
                return result;
            }

            // Color
            ColorKeyFrameAnimation ColorAnimation_AlmostSilver_FFB5BBC4_to_SemiTransparentAlmostSilver_33B5BBC4()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), HoldThenStepEasingFunction());
                // SemiTransparentAlmostSilver_33B5BBC4
                result.InsertKeyFrame(0.0482085906F, Color.FromArgb(0x33, 0xB5, 0xBB, 0xC4), CubicBezierEasingFunction_0());
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.131466255F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // SemiTransparentAlmostSilver_33B5BBC4
                result.InsertKeyFrame(0.21910429F, Color.FromArgb(0x33, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.30674848F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // SemiTransparentAlmostSilver_33B5BBC4
                result.InsertKeyFrame(0.438214719F, Color.FromArgb(0x33, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.530239284F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // SemiTransparentAlmostSilver_33B5BBC4
                result.InsertKeyFrame(0.613496959F, Color.FromArgb(0x33, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.69325155F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // SemiTransparentAlmostSilver_33B5BBC4
                result.InsertKeyFrame(0.760736167F, Color.FromArgb(0x33, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.87730062F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // SemiTransparentAlmostSilver_33B5BBC4
                result.InsertKeyFrame(1, Color.FromArgb(0x33, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                return result;
            }

            // Color
            ColorKeyFrameAnimation ColorAnimation_AlmostSilver_FFB5BBC4_to_SemiTransparentAlmostSilver_4CB5BBC4()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _holdThenStepEasingFunction);
                // SemiTransparentAlmostSilver_4CB5BBC4
                result.InsertKeyFrame(0.0785733312F, Color.FromArgb(0x4C, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.214286655F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // SemiTransparentAlmostSilver_4CB5BBC4
                result.InsertKeyFrame(0.357139975F, Color.FromArgb(0x4C, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.49999997F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // SemiTransparentAlmostSilver_4CB5BBC4
                result.InsertKeyFrame(0.714286625F, Color.FromArgb(0x4C, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.864286661F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // SemiTransparentAlmostSilver_4CB5BBC4
                result.InsertKeyFrame(1, Color.FromArgb(0x4C, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                return result;
            }

            // Color
            ColorKeyFrameAnimation ColorAnimation_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_0()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _holdThenStepEasingFunction);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.0733333305F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.199999988F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.333333313F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.466666639F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.666666627F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.806666613F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.933333337F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                return result;
            }

            // Color
            ColorKeyFrameAnimation ColorAnimation_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_1()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), StepThenHoldEasingFunction());
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.0399999991F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _holdThenStepEasingFunction);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.11333333F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.239999995F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.373333305F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.50666666F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.706666648F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.846666634F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.973333359F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                return result;
            }

            // Color
            ColorKeyFrameAnimation ColorAnimation_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_2()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                ...
                result.InsertKeyFrame(0, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _holdThenStepEasingFunction);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.0538616367F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.146905661F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.244836479F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.342767298F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.489672959F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.59250313F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.685534596F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.754716992F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.874213815F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(1, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                return result;
            }

            // Color
            ColorKeyFrameAnimation ColorAnimation_SemiTransparentAlmostCoral_4CEE9545_to_TransparentAlmostCoral_00EE9545()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                // SemiTransparentAlmostCoral_4CEE9545
                result.InsertKeyFrame(0, Color.FromArgb(0x4C, 0xEE, 0x95, 0x45), _holdThenStepEasingFunction);
                // AlmostCoral_FFEE9545
                result.InsertKeyFrame(0.50666666F, Color.FromArgb(0xFF, 0xEE, 0x95, 0x45), _cubicBezierEasingFunction_0);
                // TransparentAlmostCoral_00EE9545
                result.InsertKeyFrame(0.99333334F, Color.FromArgb(0x00, 0xEE, 0x95, 0x45), _cubicBezierEasingFunction_0);
                return result;
            }

            // Color
            ColorKeyFrameAnimation ColorAnimation_SemiTransparentAlmostLightSalmon_4CFFC270_to_TransparentAlmostLightSalmon_00FFC270()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                // SemiTransparentAlmostLightSalmon_4CFFC270
                result.InsertKeyFrame(0, Color.FromArgb(0x4C, 0xFF, 0xC2, 0x70), _holdThenStepEasingFunction);
                // SemiTransparentAlmostLightSalmon_4CFFC270
                result.InsertKeyFrame(0.50666666F, Color.FromArgb(0x4C, 0xFF, 0xC2, 0x70), _cubicBezierEasingFunction_0);
                // TransparentAlmostLightSalmon_00FFC270
                result.InsertKeyFrame(0.946666658F, Color.FromArgb(0x00, 0xFF, 0xC2, 0x70), _cubicBezierEasingFunction_0);
                return result;
            }

            // Color
            ColorKeyFrameAnimation ColorAnimation_TransparentAlmostSilver_00B5BBC4_to_TransparentAlmostSilver_00B5BBC4()
            {
                var result = _c.CreateColorKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InterpolationColorSpace = CompositionColorSpace.Rgb;
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _holdThenStepEasingFunction);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.0666666627F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.140000001F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.266666651F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.399999976F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.533333302F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(0.73333329F, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // AlmostSilver_FFB5BBC4
                result.InsertKeyFrame(0.873333275F, Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                // TransparentAlmostSilver_00B5BBC4
                result.InsertKeyFrame(1, Color.FromArgb(0x00, 0xB5, 0xBB, 0xC4), _cubicBezierEasingFunction_0);
                return result;
            }

            CompositionColorBrush ColorBrush_AlmostChocolate_FFEA6C17()
            {
                return _colorBrush_AlmostChocolate_FFEA6C17 = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xEA, 0x6C, 0x17));
            }

            // Path 1
            CompositionColorBrush ColorBrush_AlmostDarkGray_FF9BA8B7()
            {
                return _c.CreateColorBrush(Color.FromArgb(0xFF, 0x9B, 0xA8, 0xB7));
            }

            CompositionColorBrush ColorBrush_AlmostDarkSlateBlue_FF465F7A()
            {
                return _colorBrush_AlmostDarkSlateBlue_FF465F7A = _c.CreateColorBrush(Color.FromArgb(0xFF, 0x46, 0x5F, 0x7A));
            }

            CompositionColorBrush ColorBrush_AlmostDarkSlateGray_FF334F6C()
            {
                return _colorBrush_AlmostDarkSlateGray_FF334F6C = _c.CreateColorBrush(Color.FromArgb(0xFF, 0x33, 0x4F, 0x6C));
            }

            // Path 1
            CompositionColorBrush ColorBrush_AlmostDimGray_FF5B6C7E()
            {
                return _c.CreateColorBrush(Color.FromArgb(0xFF, 0x5B, 0x6C, 0x7E));
            }

            // Path 1
            CompositionColorBrush ColorBrush_AlmostDimGray_FF5B6D7D()
            {
                return _c.CreateColorBrush(Color.FromArgb(0xFF, 0x5B, 0x6D, 0x7D));
            }

            CompositionColorBrush ColorBrush_AlmostDimGray_FF707174()
            {
                return _colorBrush_AlmostDimGray_FF707174 = _c.CreateColorBrush(Color.FromArgb(0xFF, 0x70, 0x71, 0x74));
            }

            CompositionColorBrush ColorBrush_AlmostLightGray_FFC6D3E2()
            {
                return _colorBrush_AlmostLightGray_FFC6D3E2 = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xC6, 0xD3, 0xE2));
            }

            // Path 1
            CompositionColorBrush ColorBrush_AlmostLightGray_FFC7D3E1()
            {
                return _c.CreateColorBrush(Color.FromArgb(0xFF, 0xC7, 0xD3, 0xE1));
            }

            // Path 1
            CompositionColorBrush ColorBrush_AlmostLightSlateGray_FF8694A1()
            {
                return _c.CreateColorBrush(Color.FromArgb(0xFF, 0x86, 0x94, 0xA1));
            }

            // Path 1
            CompositionColorBrush ColorBrush_AlmostLightSlateGray_FF8895A2()
            {
                return _c.CreateColorBrush(Color.FromArgb(0xFF, 0x88, 0x95, 0xA2));
            }

            CompositionColorBrush ColorBrush_AlmostMidnightBlue_FF001B46()
            {
                return _colorBrush_AlmostMidnightBlue_FF001B46 = _c.CreateColorBrush(Color.FromArgb(0xFF, 0x00, 0x1B, 0x46));
            }

            CompositionColorBrush ColorBrush_AlmostMidnightBlue_FF002D5B()
            {
                return _colorBrush_AlmostMidnightBlue_FF002D5B = _c.CreateColorBrush(Color.FromArgb(0xFF, 0x00, 0x2D, 0x5B));
            }

            // Layer (Shape): astrounat Outlines
            // Path 1
            CompositionColorBrush ColorBrush_AlmostMidnightBlue_FF002E5B()
            {
                return _c.CreateColorBrush(Color.FromArgb(0xFF, 0x00, 0x2E, 0x5B));
            }

            // Layer (Shape): astrounat Outlines
            // Path 1
            CompositionColorBrush ColorBrush_AlmostMidnightBlue_FF0A406B()
            {
                return _c.CreateColorBrush(Color.FromArgb(0xFF, 0x0A, 0x40, 0x6B));
            }

            CompositionColorBrush ColorBrush_AlmostSandyBrown_FFEF9450()
            {
                return _colorBrush_AlmostSandyBrown_FFEF9450 = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xEF, 0x94, 0x50));
            }

            CompositionColorBrush ColorBrush_AlmostSilver_FFB5BBC4()
            {
                return _colorBrush_AlmostSilver_FFB5BBC4 = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xB5, 0xBB, 0xC4));
            }

            CompositionColorBrush ColorBrush_AlmostSilver_FFC2C8D1()
            {
                return _colorBrush_AlmostSilver_FFC2C8D1 = _c.CreateColorBrush(Color.FromArgb(0xFF, 0xC2, 0xC8, 0xD1));
            }

            // Path 1
            CompositionColorBrush ColorBrush_AlmostSlateGray_FF717C86()
            {
                return _c.CreateColorBrush(Color.FromArgb(0xFF, 0x71, 0x7C, 0x86));
            }

            // Path 1
            CompositionColorBrush ColorBrush_SemiTransparentAlmostMidnightBlue_19001C46()
            {
                return _c.CreateColorBrush(Color.FromArgb(0x19, 0x00, 0x1C, 0x46));
            }
            ...
            CompositionContainerShape ContainerShape_0()
            {
                ...
                propertySet.InsertVector2("Position", new Vector2(35.6590004F, 270.362F));
                result.CenterPoint = new Vector2(293.037994F, 258.901001F);
                var shapes = result.Shapes;
                shapes.Add(SpriteShape_37());
                result.StartAnimation("RotationAngleInDegrees", RotationAngleInDegreesScalarAnimation_m25_to_18());
                var controller = result.TryGetAnimationController("RotationAngleInDegrees");
                controller.Pause();
                controller.StartAnimation("Progress", _scalarExpressionAnimation);
                _reusableExpressionAnimation.ClearAllParameters();
                _reusableExpressionAnimation.Expression = "Vector2((my.Position.X - 293.038),(my.Position.Y - 258.901))";
            ...
            CompositionContainerShape ContainerShape_1()
            {
                var result = _c.CreateContainerShape();
                var propertySet = result.Properties;
                propertySet.InsertVector2("Position", new Vector2(38.5F, 270.5F));
                var shapes = result.Shapes;
                shapes.Add(SpriteShape_38());
                _reusableExpressionAnimation.ClearAllParameters();
                _reusableExpressionAnimation.Expression = "Vector2((my.Position.X - 296.5),(my.Position.Y - 262.5))";
                _reusableExpressionAnimation.SetReferenceParameter("my", result);
                result.StartAnimation("Offset", _reusableExpressionAnimation);
            ...
            {
                var result = _c.CreateContainerShape();
                result.CenterPoint = new Vector2(282, 470);
                var shapes = result.Shapes;
                ...
                result.StartAnimation("RotationAngleInDegrees", RotationAngleInDegreesScalarAnimation_m7_to_m7());
                var controller = result.TryGetAnimationController("RotationAngleInDegrees");
                controller.Pause();
                controller.StartAnimation("Progress", _scalarExpressionAnimation);
                return result;
            ...
            {
                return _cubicBezierEasingFunction_1 = _c.CreateCubicBezierEasingFunction(new Vector2(0.333000004F, 0), new Vector2(0.666999996F, 1));
            }
            ...
            CanvasGeometry Geometry_01()
            {
                ...
                {
                    builder.SetFilledRegionDetermination(CanvasFilledRegionDetermination.Winding);
                    builder.BeginFigure(new Vector2(7, 0));
                    builder.AddCubicBezier(new Vector2(7, 3.86599994F), new Vector2(3.86599994F, 7), new Vector2(0, 7));
                    builder.AddCubicBezier(new Vector2(-3.86599994F, 7), new Vector2(-7, 3.86599994F), new Vector2(-7, 0));
                    builder.AddCubicBezier(new Vector2(-7, -3.86599994F), new Vector2(-3.86599994F, -7), new Vector2(0, -7));
                    builder.AddCubicBezier(new Vector2(3.86599994F, -7), new Vector2(7, -3.86599994F), new Vector2(7, 0));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    result = CanvasGeometry.CreatePath(builder);
            ...
            CanvasGeometry Geometry_02()
            {
                ...
                {
                    builder.SetFilledRegionDetermination(CanvasFilledRegionDetermination.Winding);
                    builder.BeginFigure(new Vector2(9, 0));
                    builder.AddCubicBezier(new Vector2(9, 4.97100019F), new Vector2(4.97100019F, 9), new Vector2(0, 9));
                    builder.AddCubicBezier(new Vector2(-4.97100019F, 9), new Vector2(-9, 4.97100019F), new Vector2(-9, 0));
                    builder.AddCubicBezier(new Vector2(-9, -4.97100019F), new Vector2(-4.97100019F, -9), new Vector2(0, -9));
                    builder.AddCubicBezier(new Vector2(4.97100019F, -9), new Vector2(9, -4.97100019F), new Vector2(9, 0));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    result = CanvasGeometry.CreatePath(builder);
            ...
            CanvasGeometry Geometry_03()
            {
                ...
                {
                    builder.SetFilledRegionDetermination(CanvasFilledRegionDetermination.Winding);
                    builder.BeginFigure(new Vector2(5.5F, 0));
                    builder.AddCubicBezier(new Vector2(5.5F, 3.03699994F), new Vector2(3.03800011F, 5.5F), new Vector2(0, 5.5F));
                    builder.AddCubicBezier(new Vector2(-3.03800011F, 5.5F), new Vector2(-5.5F, 3.03699994F), new Vector2(-5.5F, 0));
                    builder.AddCubicBezier(new Vector2(-5.5F, -3.03699994F), new Vector2(-3.03800011F, -5.5F), new Vector2(0, -5.5F));
                    builder.AddCubicBezier(new Vector2(3.03800011F, -5.5F), new Vector2(5.5F, -3.03699994F), new Vector2(5.5F, 0));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    result = CanvasGeometry.CreatePath(builder);
            ...
            CanvasGeometry Geometry_04()
            {
                ...
                {
                    builder.SetFilledRegionDetermination(CanvasFilledRegionDetermination.Winding);
                    builder.BeginFigure(new Vector2(3, 0));
                    builder.AddCubicBezier(new Vector2(3, 1.65699995F), new Vector2(1.65699995F, 3), new Vector2(0, 3));
                    builder.AddCubicBezier(new Vector2(-1.65699995F, 3), new Vector2(-3, 1.65699995F), new Vector2(-3, 0));
                    builder.AddCubicBezier(new Vector2(-3, -1.65699995F), new Vector2(-1.65699995F, -3), new Vector2(0, -3));
                    builder.AddCubicBezier(new Vector2(1.65699995F, -3), new Vector2(3, -1.65699995F), new Vector2(3, 0));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    result = CanvasGeometry.CreatePath(builder);
            ...
            CanvasGeometry Geometry_05()
            {
                ...
                {
                    builder.SetFilledRegionDetermination(CanvasFilledRegionDetermination.Winding);
                    builder.BeginFigure(new Vector2(11, 0));
                    builder.AddCubicBezier(new Vector2(11, 6.07499981F), new Vector2(6.07499981F, 11), new Vector2(0, 11));
                    builder.AddCubicBezier(new Vector2(-6.07499981F, 11), new Vector2(-11, 6.07499981F), new Vector2(-11, 0));
                    builder.AddCubicBezier(new Vector2(-11, -6.07499981F), new Vector2(-6.07499981F, -11), new Vector2(0, -11));
                    builder.AddCubicBezier(new Vector2(6.07499981F, -11), new Vector2(11, -6.07499981F), new Vector2(11, 0));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    result = CanvasGeometry.CreatePath(builder);
            ...
            CanvasGeometry Geometry_06()
            {
                ...
                {
                    builder.SetFilledRegionDetermination(CanvasFilledRegionDetermination.Winding);
                    builder.BeginFigure(new Vector2(4.5F, 0));
                    builder.AddCubicBezier(new Vector2(4.5F, 2.4849999F), new Vector2(2.4849999F, 4.5F), new Vector2(0, 4.5F));
                    builder.AddCubicBezier(new Vector2(-2.4849999F, 4.5F), new Vector2(-4.5F, 2.4849999F), new Vector2(-4.5F, 0));
                    builder.AddCubicBezier(new Vector2(-4.5F, -2.4849999F), new Vector2(-2.4849999F, -4.5F), new Vector2(0, -4.5F));
                    builder.AddCubicBezier(new Vector2(2.4849999F, -4.5F), new Vector2(4.5F, -2.4849999F), new Vector2(4.5F, 0));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    result = CanvasGeometry.CreatePath(builder);
            ...
            CanvasGeometry Geometry_07()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    ...
                    builder.AddCubicBezier(new Vector2(27.8460007F, -50.4539986F), new Vector2(50.4539986F, -27.8470001F), new Vector2(50.4539986F, 0));
                    ...
                    builder.AddCubicBezier(new Vector2(-27.8470001F, 50.4539986F), new Vector2(-50.4550018F, 27.8470001F), new Vector2(-50.4550018F, 0));
            ...
            CanvasGeometry Geometry_19()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    ...
                    builder.AddLine(new Vector2(-54, -40.7070007F));
                    builder.AddLine(new Vector2(-53.9990005F, -40.7879982F));
                    builder.AddLine(new Vector2(-53.9990005F, -40.8079987F));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    builder.BeginFigure(new Vector2(-54, -40.6539993F));
                    builder.AddLine(new Vector2(-54.0009995F, -40.5250015F));
                    builder.AddLine(new Vector2(-54, -40.6430016F));
                    builder.AddLine(new Vector2(-54, -40.6539993F));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    ...
                    builder.AddLine(new Vector2(-54, -40.1899986F));
                    builder.AddLine(new Vector2(-54, -40.2039986F));
                    builder.AddLine(new Vector2(-54.0009995F, -40.3050003F));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    builder.BeginFigure(new Vector2(-54, -40.1339989F));
                    builder.AddLine(new Vector2(-53.9990005F, -40.0349998F));
                    builder.AddLine(new Vector2(-54, -40.0579987F));
                    builder.AddLine(new Vector2(-54, -40.1339989F));
                    builder.EndFigure(CanvasFigureLoop.Open);
            ...
            CanvasGeometry Geometry_31()
            {
                ...
                {
                    builder.SetFilledRegionDetermination(CanvasFilledRegionDetermination.Winding);
                    builder.BeginFigure(new Vector2(-38.8950005F, -6));
                    ...
                    builder.AddLine(new Vector2(-38.8950005F, -6));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    result = CanvasGeometry.CreatePath(builder);
                }
                return result;
            ...
            CanvasGeometry Geometry_39()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    ...
                    builder.AddCubicBezier(new Vector2(53.3019981F, -5.50899982F), new Vector2(59.4410019F, 6.7579999F), new Vector2(60.7459984F, 20));
            ...
            CanvasGeometry Geometry_40()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    ...
                    builder.AddCubicBezier(new Vector2(-24.7000008F, -35.730999F), new Vector2(-22.4960003F, -22.3180008F), new Vector2(-18, -14.9169998F));
                    ...
                    builder.AddCubicBezier(new Vector2(-28.9860001F, -22), new Vector2(-31.1900005F, -35.4140015F), new Vector2(-34.0229988F, -44.2140007F));
            ...
            CanvasGeometry Geometry_43()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    ...
                    builder.AddCubicBezier(new Vector2(9, 11.0240002F), new Vector2(8.68999958F, 11.5369997F), new Vector2(8.40400028F, 12.0640001F));
            ...
            CanvasGeometry Geometry_48()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    ...
                    builder.AddCubicBezier(new Vector2(-9.35499954F, 9.70199966F), new Vector2(-9.5710001F, 9.35400009F), new Vector2(-9.78999996F, 9));
            ...
            CanvasGeometry Geometry_56()
            {
                ...
                {
                    builder.SetFilledRegionDetermination(CanvasFilledRegionDetermination.Winding);
                    builder.BeginFigure(new Vector2(-2.77600002F, -8));
                    ...
                    builder.AddCubicBezier(new Vector2(4.921F, 3.24000001F), new Vector2(4.64699984F, 7.35099983F), new Vector2(2.77699995F, 8));
                    ...
                    builder.AddCubicBezier(new Vector2(-4.921F, -3.24000001F), new Vector2(-4.64499998F, -7.35099983F), new Vector2(-2.77600002F, -8));
                    builder.EndFigure(CanvasFigureLoop.Open);
                    result = CanvasGeometry.CreatePath(builder);
                }
                return result;
            ...
            CompositionPathGeometry PathGeometry_31()
            {
                ...
                result.StartAnimation("TrimStart", TrimStartScalarAnimation_0p82_to_0());
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_32()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_33()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_34()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_35()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_36()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_37()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_38()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_39()));
                return result;
            }

            CompositionPathGeometry PathGeometry_40()
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_40()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_41()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_42()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_43()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_44()));
                return result;
            }

            CompositionPathGeometry PathGeometry_45()
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_45()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_46()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_47()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_48()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_49()));
                return result;
            }

            CompositionPathGeometry PathGeometry_50()
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_50()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_51()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_52()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_53()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_54()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_55()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_56()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_57()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_58()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_59()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_60()));
                return result;
            }
            ...
            {
                var result = _c.CreatePathGeometry(new CompositionPath(Geometry_61()));
                return result;
            }
            ...
            Vector2KeyFrameAnimation PositionVector2Animation_0()
            {
                ...
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InsertKeyFrame(0, new Vector2(35.6590004F, 270.362F), _holdThenStepEasingFunction);
                result.InsertExpressionKeyFrame(0.506666541F, "(Pow(1 - _.t0, 3) * Vector2(35.659,270.362)) + (3 * Square(1 - _.t0) * _.t0 * Vector2(129.646,257.31)) + (3 * (1 - _.t0) * Square(_.t0) * Vector2(154.8144,264.8925)) + (Pow(_.t0, 3) * Vector2(217.166,280.66))", _stepThenHoldEasingFunction);
                result.InsertExpressionKeyFrame(0.99333322F, "(Pow(1 - _.t0, 3) * Vector2(217.166,280.66)) + (3 * Square(1 - _.t0) * _.t0 * Vector2(317.2385,305.9664)) + (3 * (1 - _.t0) * Square(_.t0) * Vector2(397.2203,348.0689)) + (Pow(_.t0, 3) * Vector2(435.659,372.362))", _stepThenHoldEasingFunction);
                result.InsertKeyFrame(0.99333334F, new Vector2(435.658997F, 372.362F), _stepThenHoldEasingFunction);
                return result;
            }
            ...
            Vector2KeyFrameAnimation PositionVector2Animation_1()
            {
                ...
                result.SetReferenceParameter("_", _root);
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InsertKeyFrame(0, new Vector2(38.5F, 270.5F), _holdThenStepEasingFunction);
                result.InsertExpressionKeyFrame(0.99333322F, "(Pow(1 - _.t1, 3) * Vector2(38.5,270.5)) + (3 * Square(1 - _.t1) * _.t1 * Vector2(244,235.5)) + (3 * (1 - _.t1) * Square(_.t1) * Vector2(403.5,325.5)) + (Pow(_.t1, 3) * Vector2(464.5,360.5))", _stepThenHoldEasingFunction);
                result.InsertKeyFrame(0.99333334F, new Vector2(464.5F, 360.5F), _stepThenHoldEasingFunction);
                return result;
            }
            ...
            ContainerVisual Root()
            {
                ...
                result.StartAnimation("t0", t0ScalarAnimation_1_to_1());
                var controller = result.TryGetAnimationController("t0");
                controller.Pause();
                controller.StartAnimation("Progress", _scalarExpressionAnimation);
                result.StartAnimation("t1", t1ScalarAnimation_to_1());
            ...
            ScalarKeyFrameAnimation RotationAngleInDegreesScalarAnimation_m25_to_18()
            {
                ...
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InsertKeyFrame(0, -25, _holdThenStepEasingFunction);
                result.InsertKeyFrame(0.50666666F, 2, _cubicBezierEasingFunction_0);
                result.InsertKeyFrame(0.99333334F, 18, _cubicBezierEasingFunction_0);
                return result;
            }
            ...
            ScalarKeyFrameAnimation RotationAngleInDegreesScalarAnimation_m7_to_m7()
            {
                var result = _c.CreateScalarKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InsertKeyFrame(0, -7, _holdThenStepEasingFunction);
                result.InsertKeyFrame(0.479999989F, 3, CubicBezierEasingFunction_1());
                result.InsertKeyFrame(1, -7, _cubicBezierEasingFunction_1);
                return result;
            }
            ...
            CompositionSpriteShape SpriteShape_00()
            {
                ...
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 247.975006F, 238.895004F);
                result.FillBrush = ColorBrush_SemiTransparentAlmostMidnightBlue_19001C46();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 333, 465);
                result.FillBrush = AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_SemiTransparentAlmostSilver_33B5BBC4();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 472, 234);
                result.FillBrush = AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_SemiTransparentAlmostSilver_4CB5BBC4();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 60.5F, 341.5F);
                result.FillBrush = AnimatedColorBrush_AlmostDarkGray_FF8EA7C1_to_TransparentAlmostDarkGray_008EA7C1_0();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 226, 433);
                result.FillBrush = AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_0();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 295, 404);
                result.FillBrush = ColorBrush_AlmostSilver_FFB5BBC4();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 274, 336);
                result.FillBrush = AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_1();
                result.Geometry = _pathGeometry_04;
                return result;
            }
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 277, 222);
                result.FillBrush = _colorBrush_AlmostSilver_FFB5BBC4;
                result.Geometry = _pathGeometry_04;
                return result;
            }
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 183, 232);
                result.FillBrush = AnimatedColorBrush_TransparentAlmostSilver_00B5BBC4_to_TransparentAlmostSilver_00B5BBC4();
                result.Geometry = _pathGeometry_04;
                return result;
            }
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 263, 162);
                result.FillBrush = AnimatedColorBrush_AlmostDarkGray_FF8EA7C1_to_TransparentAlmostDarkGray_008EA7C1_1();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 60.5F, 226.5F);
                result.FillBrush = _animatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_0;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 101.5F, 135.5F);
                result.FillBrush = AnimatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_2();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 283, 25);
                result.FillBrush = _animatedColorBrush_AlmostSilver_FFB5BBC4_to_TransparentAlmostSilver_00B5BBC4_0;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 182.544998F, 346.877014F);
                result.FillBrush = ColorBrush_AlmostLightSlateGray_FF8895A2();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 179.848999F, 355.341003F);
                result.FillBrush = ColorBrush_AlmostSlateGray_FF717C86();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 159.610992F, 172.546005F);
                result.FillBrush = ColorBrush_AlmostSandyBrown_FFEF9450();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 158.414993F, 174.554001F);
                result.FillBrush = ColorBrush_AlmostChocolate_FFEA6C17();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 166.363998F, 157.584F);
                result.FillBrush = ColorBrush_AlmostLightSlateGray_FF8694A1();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 167.139999F, 150.699997F);
                result.FillBrush = ColorBrush_AlmostDimGray_FF5B6C7E();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 218.692993F, 98.4219971F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 215.546997F, 98.6579971F);
                result.FillBrush = _colorBrush_AlmostChocolate_FFEA6C17;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 205.444F, 107.797997F);
                result.FillBrush = ColorBrush_AlmostSilver_FFC2C8D1();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 198.923996F, 109.633003F);
                result.FillBrush = ColorBrush_AlmostLightGray_FFC7D3E1();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 194.994003F, 139.475006F);
                result.FillBrush = _colorBrush_AlmostSilver_FFC2C8D1;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 188.328995F, 151.526993F);
                result.FillBrush = ColorBrush_AlmostDimGray_FF5B6D7D();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 155.363998F, 111.446999F);
                result.FillBrush = ColorBrush_AlmostLightGray_FFC6D3E2();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 148.225006F, 119.509003F);
                result.FillBrush = ColorBrush_AlmostDarkGray_FF9BA8B7();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 111.845001F, 75.5479965F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 108.905998F, 77.1179962F);
                result.FillBrush = _colorBrush_AlmostChocolate_FFEA6C17;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 169.871002F, 120.106003F);
                result.FillBrush = _colorBrush_AlmostSilver_FFC2C8D1;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 167.035004F, 124.445999F);
                result.FillBrush = ColorBrush_AlmostDimGray_FF707174();
            ...
            CompositionSpriteShape SpriteShape_31()
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 169.871002F, 120.106003F);
                result.FillBrush = ColorBrush_AlmostMidnightBlue_FF002D5B();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 167.688004F, 123.446999F);
                result.FillBrush = ColorBrush_AlmostMidnightBlue_FF001B46();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 138.945999F, 95.8320007F);
                result.FillBrush = _colorBrush_AlmostSilver_FFC2C8D1;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 136.110001F, 100.171997F);
                result.FillBrush = _colorBrush_AlmostDimGray_FF707174;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 138.947006F, 95.8320007F);
                result.FillBrush = _colorBrush_AlmostMidnightBlue_FF002D5B;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 136.763F, 99.1729965F);
                result.FillBrush = _colorBrush_AlmostMidnightBlue_FF001B46;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 249.658997F, 251.362F);
                result.FillBrush = AnimatedColorBrush_SemiTransparentAlmostLightSalmon_4CFFC270_to_TransparentAlmostLightSalmon_00FFC270();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 296.5F, 262.5F);
                result.FillBrush = AnimatedColorBrush_SemiTransparentAlmostCoral_4CEE9545_to_TransparentAlmostCoral_00EE9545();
                result.Geometry = _pathGeometry_06;
                return result;
            }
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 335.808014F, 343.415009F);
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 375.923004F, 314.862F);
                result.FillBrush = _colorBrush_AlmostSilver_FFB5BBC4;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 425.346008F, 294.375F);
                result.FillBrush = _colorBrush_AlmostSilver_FFB5BBC4;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 406.311005F, 99.4209976F);
                result.FillBrush = _colorBrush_AlmostSilver_FFB5BBC4;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 323.674988F, 239.112F);
                result.FillBrush = _colorBrush_AlmostSilver_FFB5BBC4;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 326.061005F, 201.074997F);
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 400.932007F, 137.063995F);
                result.FillBrush = _colorBrush_White;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 388.359009F, 228.432999F);
                result.FillBrush = _colorBrush_White;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 369.011993F, 250.246002F);
                result.FillBrush = _colorBrush_AlmostSilver_FFB5BBC4;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 419.325989F, 134.246002F);
                result.FillBrush = _colorBrush_AlmostSilver_FFB5BBC4;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 355.438995F, 157.878006F);
                result.FillBrush = _colorBrush_AlmostChocolate_FFEA6C17;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 316.792999F, 192.962997F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 326.18399F, 200.115997F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 408.014008F, 150.921997F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 414.278015F, 160.914993F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 371.82901F, 243.740005F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 365.295013F, 244.772995F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 419.589996F, 226.195999F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 419.589996F, 227.285004F);
                result.FillBrush = _colorBrush_AlmostSandyBrown_FFEF9450;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 336.856995F, 112.722F);
                result.FillBrush = _colorBrush_White;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 337.623993F, 110.001999F);
                result.FillBrush = _colorBrush_AlmostSilver_FFB5BBC4;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 339.632996F, 133.548996F);
                result.FillBrush = _colorBrush_AlmostSilver_FFB5BBC4;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 340.134003F, 107.565002F);
                result.FillBrush = ColorBrush_AlmostDarkSlateBlue_FF465F7A();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 291.214996F, 125.202003F);
                result.FillBrush = ColorBrush_AlmostDarkSlateGray_FF334F6C();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 290.643005F, 125.575996F);
                result.FillBrush = _colorBrush_AlmostDarkSlateBlue_FF465F7A;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 386.052002F, 88.3339996F);
                result.FillBrush = _colorBrush_AlmostDarkSlateGray_FF334F6C;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 386.747009F, 88.0630035F);
                result.FillBrush = _colorBrush_AlmostDarkSlateBlue_FF465F7A;
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 340.609985F, 103.547997F);
                result.FillBrush = ColorBrush_AlmostMidnightBlue_FF002E5B();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 360.173004F, 94.0329971F);
                result.FillBrush = ColorBrush_AlmostMidnightBlue_FF0A406B();
            ...
            {
                var result = _c.CreateSpriteShape();
                result.TransformMatrix = new Matrix3x2(1, 0, 0, 1, 375.5F, 187.5F);
                result.FillBrush = _colorBrush_AlmostLightGray_FFC6D3E2;
            ...
            ScalarKeyFrameAnimation t0ScalarAnimation_1_to_1()
            {
                var result = _c.CreateScalarKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InsertKeyFrame(0.506666541F, 1, _cubicBezierEasingFunction_0);
                result.InsertKeyFrame(0.50666666F, 0, _stepThenHoldEasingFunction);
                result.InsertKeyFrame(0.99333322F, 1, _cubicBezierEasingFunction_0);
                return result;
            }

            ScalarKeyFrameAnimation t1ScalarAnimation_to_1()
            {
                var result = _c.CreateScalarKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InsertKeyFrame(0.99333322F, 1, _cubicBezierEasingFunction_0);
            ...
            ScalarKeyFrameAnimation TrimStartScalarAnimation_0p82_to_0()
            {
                var result = _c.CreateScalarKeyFrameAnimation();
                result.Duration = TimeSpan.FromTicks(c_durationTicks);
                result.InsertKeyFrame(0, 0.819999993F, _holdThenStepEasingFunction);
                result.InsertKeyFrame(0.50666666F, 0, _cubicBezierEasingFunction_0);
                return result;
            }
